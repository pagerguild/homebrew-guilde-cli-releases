class GuildeCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/pagerguild/guilde-cli-releases/releases/download/v0.41.7/guilde-cli-darwin-arm64.zip"
      sha256 "d56629f53d5140a5904f80ab6bb3eaebaa845dc6f556fb17dcf7846acad855d4"
    end
    on_intel do
      url "https://github.com/pagerguild/guilde-cli-releases/releases/download/v0.41.7/guilde-cli-darwin-amd64.zip"
  ...
  on_linux do
    on_arm do
      url "https://github.com/pagerguild/guilde-cli-releases/releases/download/v0.41.7/guilde-cli-linux-arm64.zip"
      sha256 "a8b14becef9423af1d8ac55cdd4a5dbb4be940cf93a01ec53eb3a4d7c2d89ae0"
    end
    on_intel do
      url "https://github.com/pagerguild/guilde-cli-releases/releases/download/v0.41.7/guilde-cli-linux-amd64.zip"
